...
<body>
    ...
    <main>
        ...
        <img class="first-picture" src="assets/img/mbr-648x429.jpg" alt="photo 1">
        ...
        <div class="second-block">
            <div id="first-e">
                ...
                <div class="first-e">
                    <img class="img" src="assets/img/second_block/mbr-1-700x467.jpg" alt="image1">
            ...
            <div id="second-e">
                <img class="img" src="assets/img/second_block/mbr-2-700x466.jpg" alt="image2">
                <div class="first-text">
            ...
            <div id="third-e">
                <img class="img" src="assets/img/second_block/mbr-3-700x466.png" alt="image3">
                <div class="first-text">
            ...
            <div id="fourth-e">
                <img class="img" src="assets/img/second_block/mbr-4-700x467.jpg" alt="image4">
                <div class="first-text">
        ...
        <div class="third-block">
            <div class="images">
                <img class="img1" src="assets/img/third_block/mbr-740x500.png" alt="ABC">
                <img class="img2" src="assets/img/third_block/mbr-640x424.jpg" alt="enfant solitaire">
            </div>
        ...
        <div class="row">
            <div class="column">
                <div class="container">
                <img src="assets/img/fourth_block/mbr-1-319x240.jpg" alt="francais" class="image">
                    <div class="overlay">
            ...
            <div class="column">
                <div class="container">
                    <img src="assets/img/fourth_block/mbr-2-319x240.png" alt="infirmier" class="image">
                        <div class="overlay">
            ...
            <div class="column">
                <div class="container">
                    <img src="assets/img/fourth_block/mbr-3-300x300.jpg" alt="aide-soignant" class="image" id="aide-soignant">
                        <div class="overlay">
            ...
            <div class="column">
                <div class="container">
                    <img src="assets/img/fourth_block/mbr-4-500x500.png" alt="programmation" class="image" id="programmation">
                        <div class="overlay">
        ...
        <div>
            ...
            <img class="fifth-block" src="assets/img/fifth_block/mbr-1.jpg" alt="garde-d-enfant">
        </div>
        <div>
            ...
            <button>Read more</button>
            <img class="fifth-block" src="assets/img/fifth_block/mbr-2.jpg" alt="cours-a-domicile">
        </div>
        <!-- sixth-block  -->
        <div>
            ...
            Des progrès garantis
                <img src="assets/img/sixth_block/mbr-1.jpg" alt="des-progres-garantis">
            ...
            <img src="assets/img/sixth_block/mbr-2.jpg" alt="50%-credits-impots">
            ...
            Les nouvelles formations
                <img src="assets/img/sixth_block/mbr-3.jpg" alt="les-nouvelles-formations">
        ...
        <!-- <div class="row"> -->
            <!-- <div class="column"> -->
                <div class="seventh_block">
                    <img class="img_seventh_block" src="assets/img/seventh_block/mbr-1.jpg" alt="la_garderie">
                    <img class="img_seventh_block" src="assets/img/seventh_block/mbr-2.jpg" alt="nos_cours">
                    <img class="img_seventh_block" src="assets/img/seventh_block/mbr-3.jpg" alt="nos_formations">
                </div>
            <!-- </div>             -->
        <!-- </div>   -->
        <!-- eight-block                                         -->
